...
# Form implementation generated from reading ui file 'unit_5_NEW_TRAN.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(19, 19, 321, 331))
        ...
        self.pushButton.setGeometry(QtCore.QRect(90, 370, 75, 25))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("bmp/124.bmp"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton.setIcon(icon1)
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(Form)
        self.pushButton_2.setGeometry(QtCore.QRect(180, 370, 75, 25))
        icon2 = QtGui.QIcon()
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Выбор траспорта"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Марка"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Госномер"))
